package com.bank.bian.enterpriseplanning.model;
...
/**
 * The BIAN control record for this service domain: "Enterprise Plan Plan".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Plan) applied
 * to its asset type (Enterprise Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Enterprise Plan Plan";
